# Figma Style Commenting on Canvas

In this demo, we are using Velt SDK to add comments on HTML Canvas using custom metadata.

![Sample Canvas App](sample-app-canvas.png "Sample Canvas App")

## Features Used in Demo

- Commenting (Custom Positioning)
- Presence
- Sidebar
- Notifications
